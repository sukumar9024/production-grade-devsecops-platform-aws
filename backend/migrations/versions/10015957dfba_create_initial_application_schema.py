...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('unknown', 'healthy', 'degraded', 'unavailable', name='service_status'), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('project_id', 'name', 'environment', name='uq_service_project_name_environment')
    )
    ...
    sa.Column('status', sa.Enum('pending', 'in_progress', 'success', 'failed', 'rolled_back', name='deployment_status'), nullable=False),
    ...
    op.create_index(op.f('ix_deployments_git_commit'), 'deployments', ['git_commit'], unique=False)
    op.create_index(op.f('ix_deployments_pipeline_id'), 'deployments', ['pipeline_id'], unique=False)
